...
public class Ground {
    ...
    public void addColossusTitan(int column) {
        ...
        Titan colossusTitan = new ColossusTitan();
        cTitanList.add(new ColossusTitanView(105+(column*120)));
        if (curTitan == null) {
    ...
    public void addArmouredTitan(int column) {
        Titan curTitan = titans[9][column];
        Titan armouredTitan = new ArmouredTitan();
        aTitanList.add(new ArmouredTitanView(95+(column*120)));
        if (curTitan == null) {
